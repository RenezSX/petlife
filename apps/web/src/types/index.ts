...
export type TimelineEvent={id:string;type:string;title:string;description:string|null;date:string;status:string;responsible?:string|null;editable?:boolean;vitals?:TimelineVitals|null};
export type HospitalizationTimeline={hospitalization:{id:string;animal:Animal;bed:Bed|null;status:string;priority:string;reason:string;diagnosis:string|null;veterinarian:string|null;notes:string|null;admittedAt:string;expectedDischargeAt:string|null;dischargedAt:string|null;dischargeSummary:string|null};summary:{totalEvents:number;clinicalEntries:number;procedures:number;medicationDoses:number;stayHours:number};events:TimelineEvent[]};
